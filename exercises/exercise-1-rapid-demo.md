...
Show me the proposed schema but don't create the datamodel yet.
```

### Step 2: Create the database and tables

```
Create the PINNACLE_FINANCIAL_DEMO_<emp_id> database with the schema you designed.
...
```
Create a Cortex Analyst semantic view using SQL for the PINNACLE_FINANCIAL_DEMO_<emp_id> 
...
1. Be named "Pinnacle Financial Analyst_<emp_id>"
